...
import {
  ...
  RefreshCw, ChevronRight, Bot, GitCompare, Puzzle, Server, Database, Tag,
} from 'lucide-react';
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-2">
            ...
            <Link href="/admin/ml/labeling" className="text-center py-3 rounded-lg bg-amber-50 hover:bg-amber-100 border border-amber-200 transition-all duration-150 ease-out hover:scale-[1.02] active:scale-[0.98]">
              <Tag className="size-5 mx-auto text-amber-600 mb-0.5" />
              <div className="text-[11px] font-bold text-amber-700">Label'leme</div>
            </Link>
