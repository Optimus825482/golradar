...
const FLAGS: Omit<FeatureFlag, 'value' | 'effectiveValue' | 'overridden'>[] = [
  {
    ...
    description: 'BMA + stacking meta-model blend katsayısı (0=BMA-only, 0.5=optimum, 1=full stacking)',
    type: 'number',
    default: '0.5',
    group: 'ensemble',
  },
  ...
  },
  {
    ...
    description: 'İç/deplasman ayrı 4-rating. Brier 0.1992 (644 maç backfill).',
    type: 'toggle',
    default: 'true',
    group: 'rating',
  },
  {
    ...
    description: 'RD+σ volatility rating. RD=350 cold-start.',
    type: 'toggle',
    default: 'true',
    group: 'rating',
  },
  {
    ...
    description: 'Generalized Attacking Performance. statsJson üzerinden singleton state ile.',
    type: 'toggle',
    default: 'true',
    group: 'rating',
  },
  {
    ...
    description: 'Frank κ veya ZISM β corrector (önerilen κ=-0.30, BTTS %19 iyileşme).',
    type: 'toggle',
    default: 'true',
    group: 'corrector',
  },
