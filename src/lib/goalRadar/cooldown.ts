 ...
 *
 * 20-snapshot window (~5 min) with quadratic decay:
 *   cooldownFactor = (progress / 20)²  where progress = snapshots ago
 */
 ...
 * suppression. The opposing team gets × max(cooldownFactor, otherSide × 0.6).
 */
